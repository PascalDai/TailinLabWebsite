...
3. Compositional inverse design for **two airfoils**. Design results of 3 examples by CinDM (our). Velocities and pressure of the initial time step and the generated boundaries of 2 airfoils are presented. Training trajectories consist of single airfoil.
