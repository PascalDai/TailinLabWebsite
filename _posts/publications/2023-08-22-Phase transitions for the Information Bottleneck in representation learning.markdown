...
links: [{name: "paper",url: ""},{name: "arXiv",url: ""},{name: "video",url: ""},{name: "NeurIPS ITML",url: ""},{name: "poster",url: ""}]
layout: post
...
>**ICLR** 2020
*We theoretically analyzed the Information Bottleneck objective, to understand and predict observed phase transitions (sudden jumps in accuracy) in the prediction vs. compression tradeoff.*
