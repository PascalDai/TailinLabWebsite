...
links: [{name: "arXiv",url: "https://arxiv.org/abs/1705.01936"},{name: "code",url: "https://github.com/cgnorthcutt/rankpruning"}]
layout: post
...
*We introduce a rank pruning method for classification with noisy labels, which provably obtains similar performance as without label noise.*